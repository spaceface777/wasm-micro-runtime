...
static LLVMValueRef
compile_int_mul(AOTCompContext *comp_ctx, AOTFuncContext *func_ctx, LLVMValueRef left, LLVMValueRef right,
                bool is_i32)
{
    ...
    LLVMValueRef res;
    LLVM_BUILD_OP_OR_INTRINSIC(
        Mul, left, right, res, is_i32 ? "i32.mul" : "i64.mul", "mul", false);
                          ...
                          uint8 **p_frame_ip)
{
    switch (arith_op) {
        ...
        case INT_SUB:
            ...
            return true;
        case INT_MUL:
            DEF_INT_BINARY_OP(compile_int_mul(comp_ctx, func_ctx, left, right, is_i32),
...
static LLVMValueRef
compile_int_shl(AOTCompContext *comp_ctx, AOTFuncContext *func_ctx, LLVMValueRef left, LLVMValueRef right,
                bool is_i32)
{
    LLVMValueRef res;
    ...
    LLVM_BUILD_OP_OR_INTRINSIC(
        Shl, left, right, res, is_i32 ? "i32.shl" : "i64.shl", "shl", false);

    return res;
}

static LLVMValueRef
compile_int_shr_s(AOTCompContext *comp_ctx, AOTFuncContext *func_ctx, LLVMValueRef left,
                  LLVMValueRef right, bool is_i32)
{
    ...
    LLVM_BUILD_OP_OR_INTRINSIC(
        AShr, left, right, res, is_i32 ? "i32.shr_s" : "i64.shr_s", "shr_s",
        false);
...
static LLVMValueRef
compile_int_shr_u(AOTCompContext *comp_ctx, AOTFuncContext *func_ctx, LLVMValueRef left,
                  LLVMValueRef right, bool is_i32)
{
    LLVMValueRef res;
    ...
    LLVM_BUILD_OP_OR_INTRINSIC(
        LShr, left, right, res, is_i32 ? "i32.shr_u" : "i64.shr_u", "shr_u",
        false);
                     ...
                     IntShift shift_op, bool is_i32)
{
    switch (shift_op) {
        case INT_SHL:
            DEF_INT_BINARY_OP(compile_int_shl(comp_ctx, func_ctx, left, right, is_i32),
                              NULL);
            return true;
        case INT_SHR_S:
            DEF_INT_BINARY_OP(compile_int_shr_s(comp_ctx, func_ctx, left, right, is_i32),
                              NULL);
            return true;
        case INT_SHR_U:
            DEF_INT_BINARY_OP(compile_int_shr_u(comp_ctx, func_ctx, left, right, is_i32),
                              NULL);
            return true;
        case INT_ROTL:
            DEF_INT_BINARY_OP(
